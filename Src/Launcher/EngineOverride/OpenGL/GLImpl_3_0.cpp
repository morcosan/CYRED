...
void GLImpl_3_0::Disable( GLCapability capability )
{
	...
	switch ( capability ) {
		case GLCapability::ALPHA_TEST:	glDisable( GL_ALPHA_TEST );	break;
		case GLCapability::BLEND:		glDisable( GL_BLEND );		break;
		case GLCapability::CULL_FACE:	glDisable( GL_CULL_FACE );	break;
		case GLCapability::DEPTH_TEST:	glDisable( GL_DEPTH_TEST );	break;
	}
}
...
void GLImpl_3_0::CullFace( GLCullFace mode )
{
	...
	switch ( mode ) {
		case GLCullFace::BACK:				glCullFace( GL_BACK );			break;
		case GLCullFace::FRONT:				glCullFace( GL_FRONT );			break;
		case GLCullFace::FRONT_AND_BACK:	glCullFace( GL_FRONT_AND_BACK );	break;
	}
}
...
void GLImpl_3_0::BlendEquation( GLBlendMode mode )
{
	...
	switch ( mode ) {
		case GLBlendMode::FUNC_ADD:					glBlendEquation( GL_FUNC_ADD );				break;
		case GLBlendMode::FUNC_REVERSE_SUBTRACT:	glBlendEquation( GL_FUNC_REVERSE_SUBTRACT );	break;
		case GLBlendMode::FUNC_SUBTRACT:			glBlendEquation( GL_FUNC_SUBTRACT );			break;
	}
}
...
void GLImpl_3_0::DrawArrays( GLDrawMode mode, int first, int size )
{
	...
	switch ( mode )	{
		case GLDrawMode::TRIANGLES:	glDrawArrays( GL_TRIANGLES, first, size );	break;
	}
}
...
void GLImpl_3_0::DepthFunc( GLDepthFunc func )
{
	...
	switch ( func ) {
		case GLDepthFunc::ALWAYS:	glDepthFunc( GL_ALWAYS );	break;
		case GLDepthFunc::EQUAL:	glDepthFunc( GL_EQUAL );		break;
		case GLDepthFunc::GEQUAL:	glDepthFunc( GL_GEQUAL );	break;
		case GLDepthFunc::GREATER:	glDepthFunc( GL_GREATER );	break;
		case GLDepthFunc::LEQUAL:	glDepthFunc( GL_LEQUAL );	break;
		case GLDepthFunc::LESS:		glDepthFunc( GL_LESS );		break;
		case GLDepthFunc::NEVER:	glDepthFunc( GL_NEVER );		break;
		case GLDepthFunc::NOTEQUAL:	glDepthFunc( GL_NOTEQUAL );	break;
	}
}
