...
namespace CYRED
{
	...
	public:
		...
		void GenBuffers				( int n, OUT uint* buffers )					override;
		void DeleteBuffers			( int n, uint* buffers )						override;
		...
		void GenFramebuffers		( int size, OUT uint* framebuffers )			override;
		void DeleteFramebuffers		( int size, uint* framebuffers )				override;
		void BindFramebuffer		( GLFrameBuffer target, int framebuffer )		override;
		
		void GenTextures			( int size, OUT uint* textures )				override;
		void DeleteTextures			( int size, uint* textures )					override;
