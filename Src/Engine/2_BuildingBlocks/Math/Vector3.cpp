...
Float Vector3::S_GetX() const
{
	return x;
}


Float Vector3::S_GetY() const
{
	return y;
}


Float Vector3::S_GetZ() const
{
	return z;
}


void Vector3::S_SetX( float value )
{
	x = value;
}


void Vector3::S_SetY( float value )
{
	y = value;
}


void Vector3::S_SetZ( float value )
{
	z = value;
}
