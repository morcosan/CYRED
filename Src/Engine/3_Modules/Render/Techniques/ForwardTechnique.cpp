...
void ForwardTechnique::_RenderMesh( GameObject* gameObject )
{
    ...
    _gl->VertexAttribPointer( 1, 4, GLVarType::FLOAT, FALSE, sizeof(Vertex), (const void*) (offsetof(Vertex, color)) );
	_gl->EnableVertexAttribArray( 2 );
    _gl->VertexAttribPointer( 2, 3, GLVarType::FLOAT, FALSE, sizeof(Vertex), (const void*) (offsetof(Vertex, normal)) );
	_gl->EnableVertexAttribArray( 3 );
    _gl->VertexAttribPointer( 3, 2, GLVarType::FLOAT, FALSE, sizeof(Vertex), (const void*) (offsetof(Vertex, uv)) );
	_gl->EnableVertexAttribArray( 4 );
    _gl->VertexAttribPointer( 4, 3, GLVarType::FLOAT, FALSE, sizeof(Vertex), (const void*) (offsetof(Vertex, tangent)) );
	_gl->EnableVertexAttribArray( 5 );
    _gl->VertexAttribPointer( 5, 3, GLVarType::FLOAT, FALSE, sizeof(Vertex), (const void*) (offsetof(Vertex, bitangent)) );
	...
	_gl->UniformMatrix4fv( worldLoc,		1, FALSE, worldMatrix.GetValuePtr()			);
	_gl->UniformMatrix4fv( viewLoc,			1, FALSE, viewMatrix.GetValuePtr()			);
	_gl->UniformMatrix4fv( projectionLoc,	1, FALSE, projectionMatrix.GetValuePtr()	);
