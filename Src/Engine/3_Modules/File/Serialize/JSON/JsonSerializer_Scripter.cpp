...
rapidjson::Value JsonSerializer_Scripter::ToJson( const void* object )
{
	const Scripter* scripter = CAST_S( const Scripter*, object );
	...
	// add scripts
	{
		...
		for ( int i = 0; i < scripter->GetScriptsCount(); ++i ) {
