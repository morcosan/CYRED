...
namespace CYRED
{
	class DLL JsonSerializer_Texture : public JsonSerializer
	{
		...
		cchar* const TEXTURE_TYPE		= "texture_type";
		...
		cchar* const HAS_MIPMAP		= "has_mipmap";
		cchar* const CLEAR_BUFFER		= "clear_buffer_on_bind";
		cchar* const FILE_PATH			= "file_path";
		cchar* const FILE_PATH_POSX	= "file_path_pos_x";
		cchar* const FILE_PATH_NEGX	= "file_path_neg_x";
		cchar* const FILE_PATH_POSY	= "file_path_pos_y";
		cchar* const FILE_PATH_NEGY	= "file_path_neg_y";
		cchar* const FILE_PATH_POSZ	= "file_path_pos_z";
		cchar* const FILE_PATH_NEGZ	= "file_path_neg_z";
