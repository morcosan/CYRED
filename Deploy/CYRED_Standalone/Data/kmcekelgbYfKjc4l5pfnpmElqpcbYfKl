...
out vec3 INTER_fragNormalWorld;


void main() 
{
	INTER_fragPosWorld 		= INTER_vertPosWorld[0];
	INTER_fragNormalWorld 	= INTER_vertNormalWorld[0];
	gl_Position = gl_in[0].gl_Position;
	EmitVertex();

	INTER_fragPosWorld 		= INTER_vertPosWorld[1];
	INTER_fragNormalWorld 	= INTER_vertNormalWorld[1];
	gl_Position = gl_in[1].gl_Position;
	EmitVertex();

	INTER_fragPosWorld 		= INTER_vertPosWorld[2];
	INTER_fragNormalWorld 	= INTER_vertNormalWorld[2];
